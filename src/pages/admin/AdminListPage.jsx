...
export function DynamicAdminListPage({ activeMenu, menu }) {
  ...
  useEffect(() => {
    ...
    const queryKey = `${menu}:${remoteQueryKey}`;
    if (lastRealtimeQueryRef.current === queryKey) {
      return;
    }
          ...
          <div className="page-head__right">
            ...
            {config.actionLabel ? (
              <button
                ...
                onClick={menu === "owners" ? () => void openOwnerModal("create") : () => openAdminModal("create")}
                type="button"
              >
                {config.actionLabel}
              </button>
                    ...
                    <div className="row-actions">
                      ...
                      {menu === "groups" ? (
                        <button
                          ...
                          onClick={(event) => {
                            event.stopPropagation();
                            setGroupMemberModal({ group: row.record });
                          }}
                          type="button"
                          title="구성원 선택"
                        >
